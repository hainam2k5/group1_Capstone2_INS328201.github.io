...
const DICT: Record<Lang, Dict> = {
  vi: {
    ...
    "appt.title": "Lịch hẹn cố vấn", "appt.when": "Thời gian", "appt.note": "Ghi chú (tùy chọn)", "appt.notePh": "Nội dung muốn trao đổi…", "appt.book": "Đặt lịch hẹn", "appt.none": "Chưa có lịch hẹn nào.", "appt.cancel": "Hủy", "appt.confirm": "Xác nhận", "appt.done": "Đã gặp", "appt.pickTime": "Hãy chọn thời gian hẹn.", "appt.past": "Không thể đặt lịch vào thời gian đã qua — chỉ từ hiện tại trở đi.", "appt.requested": "Đã gửi yêu cầu hẹn cố vấn.", "appt.err": "Không thao tác được lịch hẹn (kiểm tra đã chạy appointments.sql).", "appt.updated": "Đã cập nhật lịch hẹn.", "appt.st.requested": "Chờ duyệt", "appt.st.confirmed": "Đã xác nhận", "appt.st.cancelled": "Đã hủy", "appt.st.done": "Đã gặp",
