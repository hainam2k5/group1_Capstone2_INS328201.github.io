...
const DICT: Record<Lang, Dict> = {
  vi: {
    ...
    "cls.title": "Lớp học", "cls.sub": "Điểm danh & ghi điểm cho lớp bạn dạy", "cls.tabAttend": "Điểm danh", "cls.tabGrades": "Ghi điểm", "cls.weeklyNote": "Mỗi tuần 1 buổi học", "cls.sessions": "Các buổi", "cls.dayPresent": "Có mặt buổi này: {p}/{n}", "cls.semester": "Học kỳ", "cls.studentsUnit": "sinh viên", "cls.unsaved": "Có thay đổi chưa lưu — nhấn Enter hoặc bấm Lưu", "cls.gSavedNoMail": "Đã lưu điểm, nhưng KHÔNG gửi được email cho {n} sinh viên (kiểm tra GMAIL_USER / GMAIL_APP_PASSWORD).", "cls.titleAttend": "Điểm danh", "cls.subAttend": "Điểm danh theo buổi cho lớp bạn dạy", "cls.titleGrades": "Nhập điểm", "cls.subGrades": "Nhập điểm thành phần TX/GK/CK cho lớp bạn dạy", "cls.pickClass": "Chọn lớp", "cls.selectClass": "— Chọn lớp —", "cls.loadingClasses": "Đang tải danh sách lớp…", "cls.loadErr": "Không tải được danh sách lớp. Bấm để thử lại.", "cls.noClasses": "Bạn chưa được phân công lớp nào.", "cls.session": "Buổi ngày", "cls.noStudents": "Chưa có sinh viên nào trong lớp này (cần có bản ghi điểm khớp Mã môn + Học kỳ).", "cls.present": "Có mặt", "cls.attRate": "Chuyên cần", "cls.saveAttend": "Lưu điểm danh", "cls.attHint": "Tick = có mặt. Lưu sẽ tự cập nhật tỷ lệ chuyên cần của sinh viên.", "cls.saveGrades": "Lưu điểm", "cls.weightsNote": "Trọng số: TX {r} · GK {m} · CK {f}", "cls.attErr": "Không lưu được điểm danh.", "cls.attSaved": "Đã lưu điểm danh", "cls.gErr": "Điểm phải trong khoảng 0–10.", "cls.gSaved": "Đã lưu điểm", "cls.examBan": "Cấm thi", "cls.examBanNear": "Sắp cấm thi", "cls.examBanFinal": "SV bị cấm thi — không nhập được điểm cuối kỳ", "cls.banTitle": "Cảnh báo cấm thi", "cls.banBody": "Bạn đã vắng {absent} buổi môn {course}, vượt giới hạn nên có nguy cơ bị CẤM THI. Hãy liên hệ giảng viên/cố vấn ngay.",
    ...
    "cfg.weights": "Trọng số các yếu tố", "cfg.thresholds": "Ngưỡng mức rủi ro (điểm)", "cfg.weightSum": "Tổng trọng số: {sum} (nên bằng 1.00)", "cfg.weightErr": "Tổng trọng số phải bằng 1.",
    ...
    "appt.title": "Lịch hẹn cố vấn", "appt.when": "Thời gian", "appt.date": "Ngày hẹn", "appt.slot": "Khung giờ", "appt.pickSlot": "— Chọn khung giờ —", "appt.note": "Ghi chú (tùy chọn)", "appt.notePh": "Nội dung muốn trao đổi…", "appt.book": "Đặt lịch hẹn", "appt.none": "Chưa có lịch hẹn nào.", "appt.cancel": "Hủy", "appt.confirm": "Xác nhận", "appt.done": "Đã gặp", "appt.pickTime": "Hãy chọn thời gian hẹn.", "appt.past": "Không thể đặt lịch vào thời gian đã qua — chỉ từ hiện tại trở đi.", "appt.requested": "Đã gửi yêu cầu hẹn cố vấn.", "appt.err": "Không thao tác được lịch hẹn (kiểm tra đã chạy appointments.sql).", "appt.updated": "Đã cập nhật lịch hẹn.", "appt.st.requested": "Chờ duyệt", "appt.st.confirmed": "Đã xác nhận", "appt.st.cancelled": "Đã hủy", "appt.st.done": "Đã gặp",
  ...
  en: {
    ...
    "cls.title": "Classes", "cls.sub": "Attendance & grades for the classes you teach", "cls.tabAttend": "Attendance", "cls.tabGrades": "Grades", "cls.weeklyNote": "One session per week", "cls.sessions": "Sessions", "cls.dayPresent": "Present this session: {p}/{n}", "cls.semester": "Semester", "cls.studentsUnit": "students", "cls.unsaved": "Unsaved changes — press Enter or click Save", "cls.gSavedNoMail": "Grades saved, but the email to {n} student(s) failed (check GMAIL_USER / GMAIL_APP_PASSWORD).", "cls.titleAttend": "Attendance", "cls.subAttend": "Take per-session attendance for the classes you teach", "cls.titleGrades": "Grades", "cls.subGrades": "Enter TX/GK/CK component grades for the classes you teach", "cls.pickClass": "Pick a class", "cls.selectClass": "— Select class —", "cls.loadingClasses": "Loading classes…", "cls.loadErr": "Couldn't load your classes. Click to retry.", "cls.noClasses": "You have no classes assigned yet.", "cls.session": "Session date", "cls.noStudents": "No students in this class yet (needs grade records matching the course code + semester).", "cls.present": "Present", "cls.attRate": "Attendance", "cls.saveAttend": "Save attendance", "cls.attHint": "Ticked = present. Saving updates each student's attendance rate automatically.", "cls.saveGrades": "Save grades", "cls.weightsNote": "Weights: Reg {r} · Mid {m} · Final {f}", "cls.attErr": "Couldn't save attendance.", "cls.attSaved": "Attendance saved", "cls.gErr": "Scores must be between 0 and 10.", "cls.gSaved": "Grades saved", "cls.examBan": "Barred", "cls.examBanNear": "Near ban", "cls.examBanFinal": "Barred — final grade cannot be entered", "cls.banTitle": "Exam-ban warning", "cls.banBody": "You have {absent} absences in {course}, over the limit — you risk being BARRED from the exam. Contact your lecturer/advisor now.",
    ...
    "cfg.weights": "Factor weights", "cfg.thresholds": "Risk-level thresholds (score)", "cfg.weightSum": "Weight sum: {sum} (should be 1.00)", "cfg.weightErr": "Total weights must equal 1.",
    ...
    "appt.title": "Advisor appointments", "appt.when": "Time", "appt.date": "Date", "appt.slot": "Time slot", "appt.pickSlot": "— Select a slot —", "appt.note": "Note (optional)", "appt.notePh": "What you'd like to discuss…", "appt.book": "Book appointment", "appt.none": "No appointments yet.", "appt.cancel": "Cancel", "appt.confirm": "Confirm", "appt.done": "Mark done", "appt.pickTime": "Please pick a time.", "appt.past": "You can't book a time in the past — now onward only.", "appt.requested": "Appointment request sent.", "appt.err": "Couldn't update appointment (check appointments.sql was run).", "appt.updated": "Appointment updated.", "appt.st.requested": "Requested", "appt.st.confirmed": "Confirmed", "appt.st.cancelled": "Cancelled", "appt.st.done": "Done",
